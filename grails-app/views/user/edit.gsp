            ...
            <div class="authentication-inner">
                ...
                <div class="card" >
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Modifiez votre compte utilisateur et gérez votre CoinCoin! 🆕</h4>
                        <p class="mb-4">Merci de remplire les champs Suivants ...</p>
                    ...
                    <fieldset class="form">
                        ...
                        <div class='fieldcontain required'>
                            <label for='password'>Password
                                <span class='required-indicator'>*</span>
                            </label><input class="form-control" type="password" name="password" required="" value="" id="password"/>
                        </div>
                        <div class='fieldcontain required'>
                            <label for='role'>Role
                                <span class='required-indicator'>*</span>
